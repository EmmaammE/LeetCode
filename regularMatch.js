...
//   while (i+first <s.length && flag && j<p.length) {
...
//           j++;i++;
//         }
//         // else if(i+first<s.length){
//         //   if (p[0]!=='.') {
//         //      first = s.slice(i).indexOf(p[0]);
//         //      if (first === -1) {
//         //        flag = false;
//         //        console.log("elseif");
//         //      } else {
...
console.log(regularExpressionMatching('aa','a*'));